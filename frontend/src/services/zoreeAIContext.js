...
function buildActionSection() {
  return [
    ...
    "- Safe actions (auto-executed): PLAN_ORDER, UPDATE_ORDER_STATUS, UPDATE_SHIPMENT_STATUS, ASSIGN_CARRIER, HOLD_ORDER, FLAG_EXCEPTION, ADD_SHIPMENT_EVENT, COPY_ORDER, GET_RATES. Do NOT say 'click confirm' for these.",

...
<div class="scene screenshot-scene" id="scene-4">
  ...
  <div class="scene-caption">
    ...
    <div class="caption-points">
      ...
      <span class="caption-point">Bulk plan scheduler with rate shopping across TL, LTL, Partial</span>
...
const VOICE_SCRIPT = [
  ...
  { scene: 4, text: "Order management features auto-consolidation that groups orders by lane, a bulk plan scheduler for rate shopping across TL, LTL, and Partial modes, plus full status tracking from creation through delivery.", rate: 0.92 },

...
| 023 | `023_req24_oms_push_tracking_columns.sql` | REQ-24 (OMS): add tms_order_pushed_at / tms_ship_status_pushed_at / tms_pod_pushed_at on oms_orders + partial indexes + backfill. Unblocks inline tender-accept auto-sync (supersedes mistargeted 010_oms_add_tms_push_tracking.sql, which was never applied). | _pending — apply via SQL Editor_ | _pending_ |
